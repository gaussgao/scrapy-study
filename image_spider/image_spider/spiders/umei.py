...
class UmeiSpider(scrapy.Spider):
   ...
   # scrapy crawl xh --nolog
    start_urls = ['https://www.umei.cc/p/gaoqing/rihan/20130704191841_13.htm']
    # 设置一个空集合
    #url_set = set()
    ...
    def parse(self, response):
        ...
        if (False == UmeiSpider.url_list_db.query(response.url,1)):

            UmeiSpider.url_list_db.update(response.url)
            ...
            if True :
                ...
                allPics = response.xpath('//div[@class="ImageBody"]/p/a/img')
            ...
            for url in urls:
                ...
                if  url.startswith("http") and url.endswith(".html"):
                    ...
                    if UmeiSpider.url_list_db.query(url_whole):
                        #print ("Exist:",url,url_whole)
                        pass
                    else:
                        #XhSpider.url_set.add(url_whole)
                        UmeiSpider.url_list_db.insert(url_whole)
                    ...
                    url_whole = "https://www.umei.cc/p/gaoqing/rihan/"+url
        ...
        url_whole =  UmeiSpider.url_list_db.query_data()
